    ...
    <nav className='container flex flex-wrap items-center py-3 mx-auto '>
      ...
      >
        <div className='flex flex-col items-start w-full font-semibold text-white md:space-x-4 lg:inline-flex lg:flex-row lg:ml-auto lg:w-auto lg:items-center lg:h-auto'>
          <Link
            href='/about'
            className='items-center justify-center w-full px-3 py-2 hover:font-bold lg:inline-flex lg:w-auto hover:border-b-2 hover:text-optional'>
          ...
          <Link
            href='/donations'
            className='items-center justify-center w-full px-5 py-2 bg-optional hover:font-bold lg:inline-flex lg:w-auto hover:text-primary'>
